	...
	public sealed class CubismRenderer : MonoBehaviour
	{
		...
		public Color MultiplyColor
		{
			...
			set
			{
				...
				// Store value.
				_multiplyColor = (value != null) ? value : Color.white;
			}
		}
		...
		public Color ScreenColor
		{
			...
			set
			{
				...
				// Store value.
				_screenColor = (value != null) ? value : Color.black;
			}
		}
		...
		internal void OnMaskPropertiesDidChange(CubismMaskProperties newMaskProperties)
		{
			...
			var texture = newMaskProperties.Texture.RenderTextureCount > 0 ? newMaskProperties.Texture.RenderTextures[renderTextureIndex] : (Texture)newMaskProperties.Texture;
		...
		private void ApplySorting()
		{
			...
			// Sort by depth.
			var offset = (SortingMode == CubismSortingMode.BackToFrontZ) ? -DepthOffset : DepthOffset;
